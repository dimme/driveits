...
void CANClass::baudConfig()
{
  // Values for 250kbaud with 16MHz oscillator
  byte config0 = 0xC1,config1 = 0xB8,config2 = 0x05; //

  // Put it in configuration mode
  setMode(CONFIGURATION);
  delay(10);

  // Set the registers
  setRegister(CNF0,config0);
  setRegister(CNF1,config1);
  setRegister(CNF2,config2);
