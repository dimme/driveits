...
#define CANSTAT 0x0C //Mode status register
...
public:
	...
	static void baudConfig();//sets up baud
	...
	//(readStatus() & 0x40) == 0x40 means frame in buffer 0
	//(readStatus() & 0x80) == 0x80 means frame in buffer 1
